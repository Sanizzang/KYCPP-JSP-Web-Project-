                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block">
                            	<img src="./img/건양대학교 창의융합대학.png" alt="창의융합대학" width="370" height="500">
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="post" action="loginAction.jsp">
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-user" id="email" name="email" placeholder="Enter your Email">
                                        </div>
                                        <div class="form-group">
